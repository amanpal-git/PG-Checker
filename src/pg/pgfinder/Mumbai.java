...
public class Mumbai extends JFrame implements ActionListener{
    ...
    Mumbai(){
        ...
        ImageIcon im = new ImageIcon(ClassLoader.getSystemResource("proimg/spacejoy-XM-miHibz64-unsplash.png"));
        Image img2 = im.getImage().getScaledInstance(356, 200, Image.SCALE_DEFAULT);
        ImageIcon img3 = new ImageIcon(img2);
        JLabel image = new JLabel(img3);

        image.setBounds(100, 130, 356, 200);
        add(image);

        JLabel text = new JLabel("NAYA GHAR");
        text.setBounds(100, 300, 150, 100 );
        text.setForeground(Color.black);
        text.setFont(new Font("serif",Font.BOLD, 20));
        add(text);

        JLabel addr1 = new JLabel("Hiranandani Estate, Thane West, Maharashtra");
        addr1.setBounds(100, 330, 400, 100 );
        addr1.setForeground(Color.gray);
        addr1.setFont(new Font("serif",Font.PLAIN, 20));
        add(addr1);

        JLabel rent1 = new JLabel("₹ 9000 per month onwards");
        rent1.setBounds(100, 360, 400, 100 );
        rent1.setForeground(Color.gray);
        rent1.setFont(new Font("serif",Font.PLAIN, 15));
        add(rent1);

        contact1 = new JButton("Contact");
        contact1.setBounds(100,450,100,40);
        ...
        ImageIcon im1 = new ImageIcon(ClassLoader.getSystemResource("proimg/spacejoy-XM-miHibz64-unsplash.png"));
        Image img4 = im1.getImage().getScaledInstance(356, 200, Image.SCALE_DEFAULT);
        ImageIcon img5 = new ImageIcon(img4);
        JLabel image1 = new JLabel(img5);

        image1.setBounds(500, 130, 356, 200);
        add(image1);

        JLabel text2 = new JLabel("NAYA GHAR");
        text2.setBounds(500, 300, 150, 100 );
        text2.setForeground(Color.black);
        text2.setFont(new Font("serif",Font.BOLD, 20));
        add(text2);

        JLabel addr2 = new JLabel("Hiranandani Estate, Thane West, Maharashtra");
        addr2.setBounds(500, 330, 400, 100 );
        addr2.setForeground(Color.gray);
        addr2.setFont(new Font("serif",Font.PLAIN, 20));
        add(addr2);

        JLabel rent2 = new JLabel("₹ 11000 per month onwards");
        rent2.setBounds(500, 360, 400, 100 );
        rent2.setForeground(Color.gray);
        rent2.setFont(new Font("serif",Font.PLAIN, 15));
        add(rent2);

        contact2 = new JButton("Contact");
        contact2.setBounds(500,450,100,40);
        ...
        ImageIcon im2 = new ImageIcon(ClassLoader.getSystemResource("proimg/spacejoy-XM-miHibz64-unsplash.png"));
        Image img6 = im2.getImage().getScaledInstance(356, 200, Image.SCALE_DEFAULT);
        ImageIcon img7 = new ImageIcon(img6);
        JLabel image2 = new JLabel(img7);

        image2.setBounds(900, 130, 356, 200);
        add(image2);

        JLabel text3 = new JLabel("NAYA GHAR");
        text3.setBounds(900, 300, 150, 100 );
        text3.setForeground(Color.black);
        text3.setFont(new Font("serif",Font.BOLD, 20));
        add(text3);

        JLabel addr3 = new JLabel("Hiranandani Estate, Thane West, Maharashtra");
        addr3.setBounds(900, 330, 400, 100 );
        addr3.setForeground(Color.gray);
        addr3.setFont(new Font("serif",Font.PLAIN, 20));
        add(addr3);

        JLabel rent3 = new JLabel("₹ 10000 per month onwards");
        rent3.setBounds(900, 360, 400, 100 );
        rent3.setForeground(Color.gray);
        rent3.setFont(new Font("serif",Font.PLAIN, 15));
        add(rent3);

        contact3 = new JButton("Contact");
        contact3.setBounds(900,450,100,40);

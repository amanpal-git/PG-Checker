...
public class Delhi extends JFrame implements ActionListener{
    ...
    Delhi(){
        ...
        ImageIcon im = new ImageIcon(ClassLoader.getSystemResource("proimg/goa.png"));
        ...
        JLabel addr1 = new JLabel("Ramphal chowk ,Sector-7, dwarka,Delhi");
        ...
        ImageIcon im1 = new ImageIcon(ClassLoader.getSystemResource("proimg/goa.png"));
        ...
        JLabel addr2 = new JLabel("Ramphal chowk ,Sector-7, dwarka,Delhi");
        ...
        ImageIcon im2 = new ImageIcon(ClassLoader.getSystemResource("proimg/goa.png"));
        ...
        JLabel addr3 = new JLabel("Ramphal chowk ,Sector-7, dwarka,Delhi");

...
public class Hyderabad extends JFrame implements ActionListener{
    ...
    Hyderabad(){
        ...
        ImageIcon im = new ImageIcon(ClassLoader.getSystemResource("proimg/hyderabad.png"));
        ...
        JLabel addr1 = new JLabel("Sri Shyam Nagar, Telecom Nagar,Hyderabad");
        ...
        ImageIcon im1 = new ImageIcon(ClassLoader.getSystemResource("proimg/hyderabad.png"));
        ...
        JLabel addr2 = new JLabel("Sri Shyam Nagar, Telecom Nagar,Hyderabad");
        ...
        ImageIcon im2 = new ImageIcon(ClassLoader.getSystemResource("proimg/hyderabad.png"));
        ...
        JLabel addr3 = new JLabel("Sri Shyam Nagar, Telecom Nagar,Hyderabad");
